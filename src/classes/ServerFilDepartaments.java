            ...
            try { 
                ...
                switch (missatge[0]) {
                    ...
                    case "DEPA_NEW":
                        ...
                        int result =conn.altaDepartament(missatge);
                    ...
                    case "DEPA_DELETE":
                        ...
                        int resultat =conn.baixaDepartament(Integer.parseInt(missatge[1]));
                        //Mostra el resultat de l'operació 0 malament | 1 correcte
                        SystemUtils.escriuNouLog("RESULT_DELETE_DEPART_ID # " +resultat);
                    ...
                    case "DEPA_MODIFI":
                        ...
                        int update =conn.modificarDepartament(missatge);
                        //Registrar el resultat de l'operació  0 malament | 1 correcte en l'arxiu log
                         SystemUtils.escriuNouLog("MODIFI_UPDATE_DEPART_RESULT # " + update);
                    ...
                    case "DEPA_QUERY":
                        ...
                        departamentsArrayList  = conn.consultaSqlDepartaments(missatge[1]);
                    ...
                    case "DEPA_QUERY_COUNT":
                        ...
                        //Guardem en un ArrayList els registres trobats
                        departamentsArrayListCount  = conn.consultaSqlDepartaments(missatge[1]);
                        //Enviem el nombre total de elements de la llista al client
                    ...
                    case "DEPA_FIND":
                        ...
                        //Executa la baixa en la base de dades, pasant com a paràmete id_key de l'usuari
                        int id_resultat =conn.cercaIdDepartament(missatge[1]);
                        //Mostra el resultat de l'operació 0 malament | 1 correcte
                        SystemUtils.escriuNouLog("RESULT_FIND_DEPART_ID # " + id_resultat);
                        //Enviem el  resultat de l'operació 0  = INCORRECTE 1 = OK al client                     
                    ...
                    case "DEPA_EXIT":
                        ...
                        SystemUtils.escriuNouLog("EXECUTE_DEPART_EXIT_ServerfilsRols");
