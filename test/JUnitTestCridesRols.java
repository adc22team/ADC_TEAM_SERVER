...
public class JUnitTestCridesRols {
    ...
    */
    public int buscarIdDepartament(int id_conn, String departament) {
        ...
        try {
            ...
            out.writeUTF(edc.encryptedText(id_conn+",ROLE_FIND," + departament,edc.getShare_key_client().toByteArray()));
   ...
   public int modificacio(int id_conn,int id_key,String sql){
        ...
        try {
            ...
            out.writeUTF(edc.encryptedText(id_conn+",ROLE_MODIFI," + id_key 
