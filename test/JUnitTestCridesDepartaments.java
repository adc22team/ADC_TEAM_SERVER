...
public class JUnitTestCridesDepartaments {
    ...
    public JUnitTestCridesDepartaments() {
    }
    ...
    @Order(3)
     public void t3_alta_baixa_modificacio() throws InterruptedException, IOException{  //comoprova un login incorrecte
         ...
         assertEquals( alta(id_conn_correcte,"Departament prova,Descripcio Prova,66666666"),1);
         id_user =  buscarIdDepartament(id_conn_correcte,"Departament prova");
         assertEquals( modificacio(id_conn_correcte,id_user,",Departament de prova modificat, Descripcio modificada, 666 66 66"),1);
    ...
    @Test
    @Order(4)
     public void t4_buscarIdDepartament() throws InterruptedException, IOException{  //comoprova un login incorrecte

        assertNotEquals(buscarIdDepartament(id_conn_correcte,"Comercial"),0);
    }  
    ...
    */
    public int buscarIdDepartament(int id_conn, String departament) {
        ...
        try {
            ...
            out.writeUTF(edc.encryptedText(id_conn+",DEPA_FIND," + departament,edc.getShare_key_client().toByteArray()));
    ...
    */
    public int alta(int id_conn, String params) {
        ...
        try {
            ...
            out.writeUTF(edc.encryptedText(id_conn + ",DEPA_NEW," + params,edc.getShare_key_client().toByteArray()));
   ...
   public int modificacio(int id_conn,int id_key,String sql){
        ...
        try {
            ...
            out.writeUTF(edc.encryptedText(id_conn+",DEPA_MODIFI," + id_key 
    ...
    */ 
    public int baixa(int id_conn, int id_key) {
        ...
        try {
            ...
            out.writeUTF(edc.encryptedText(id_conn +",DEPA_DELETE," + id_key,edc.getShare_key_client().toByteArray()));
